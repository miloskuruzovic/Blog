<div class="container content">
	<div class="row">
		<nav class="col-sm-3">
			<ul class="list-group">
			<li class="list-group-item"><a href="all" class="list-group-item first-group-item">All Blog Posts</a>
				<ul class="list-group">
...
<?php else: ?>
	...
	<?php if ($_SESSION['status'] > 1): ?>
		<a style="margin-left: 20px;" href=<?= base_url() ."blog/add_post" ?>>Add new post?</a>
	<?php endif ?>
	<hr>
